...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 shrink-0 flex-col border-r border-white/10 bg-[#0B1F3A] transition-transform duration-300 lg:static lg:translate-x-0 ${
